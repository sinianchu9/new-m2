...
public class MyService extends Service {
    ...
    private List<ScanFilter> buildScanFilters() {
        ...
        // ParcelUuid.fromString("0000ff07-0000-1000-8000-00805f9b34fb");
    ...
    private final BluetoothAdapter.LeScanCallback mLeScanCallback = new BluetoothAdapter.LeScanCallback() {
        ...
        public void onLeScan(BluetoothDevice device, int rssi, byte[] scanRecord) {
            // TODO Auto-generated method stub
            Logger.t(TAG)
                    .i(String.format(" onLeScan device for %s-%s-%d", device.getName(), device.getAddress(), rssi));
        }
    ...
    private final ScanCallback mScanCallback = new ScanCallback() {
        ...
        public void onScanResult(int callbackType, ScanResult result) {
            ...
            if (result.getScanRecord() != null) {
                Logger.t(TAG).i(String.format("onScanResult device for %s-%s-%d", result.getDevice().getName(),
