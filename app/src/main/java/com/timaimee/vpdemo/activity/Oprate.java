...
public interface Oprate {
    ...
    String DATA_OVERVIEW = "数据展示";
    String FUNCTION_SETTINGS = "功能设置";
    ...
    String TEXT_IMAGE_MSG_PUSH = "图文推送";
    String JH58_PPG = "JH58PPG相关";
    String MINI_CHECKUP = "微体检";

    String GSR_START = "开始皮电测量";
    String GSR_STOP = "结束皮电测量";
    ...
    String[] oprateStr = new String[]{
            ...
            , START_BLOOD_GLUCOSE, STOP_BLOOD_GLUCOSE, BLOOD_GLUCOSE_P_READ, BLOOD_GLUCOSE_P_SETTING, BLOOD_GLUCOSE_MULTIPLE_READ, BLOOD_GLUCOSE_MULTIPLE_SETTING, FIND_DEVICE, BLE_RENAME, BT_RENAME, BT_READ, BLE_DISCONNECT, HEALTH_REMIND, DATA_OVERVIEW, FUNCTION_SETTINGS, FUNCTION_SWITCH,
            ...
            TEXT_IMAGE_MSG_PUSH, JH58_PPG, MINI_CHECKUP,GSR_START,GSR_STOP,ZT163_DEVICE_ALWAYS_OFF_SCREEN
    };
}
