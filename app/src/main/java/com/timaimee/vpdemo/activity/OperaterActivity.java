...
//            timeData.setCurrentTime();
            ...
            Intent intent = new Intent(this, HealthRemindActivity.class);
            intent.putExtra("deviceaddress", deviceaddress);
            startActivity(intent);
        } else if (oprater.equals(DATA_OVERVIEW)) {
            Intent intent = new Intent(this, DataOverviewActivity.class);
            intent.putExtra("deviceaddress", deviceaddress);
            startActivity(intent);
        } else if (oprater.equals(FUNCTION_SETTINGS)) {
            Intent intent = new Intent(this, FunctionSettingsActivity.class);
            intent.putExtra("deviceaddress", deviceaddress);
            startActivity(intent);
